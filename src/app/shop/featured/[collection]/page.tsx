...
import ActiveFilters from "@/components/shop/search/ActiveFilters";
import ProductGrid from "@/components/shop/search/ProductGrid";
import Pagination from "@/components/shop/search/Pagination";
import SearchSec from "@/components/shop/search/SearchBar";
      ...
      <section className="relative z-10 py-10">
        <div className="flex justify-center px-5">
          <div className="w-full max-w-[1200px]">
            <SearchSection collection={collection} />
          </div>
        </div>
      </section>
    </main>
