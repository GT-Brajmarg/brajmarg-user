      ...
      <div className="relative z-10 mx-auto flex h-full max-w-[1200px] items-center px-8">
        ...
        >
          ...
          >
            Complete Your
            <br />
            <span className="text-[#0B6670]">Secure Payment</span>
          </h1>
          ...
          >
            You're all set! Make a secure payment to
            <br />
            activate your Yearly Membership and start
            <br />
            receiving divine updates.
          </p>
