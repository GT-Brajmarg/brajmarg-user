...
export default function AnniversaryBlessingCard() {
    ...
    >
      <div className="grid grid-cols-[70px_1fr_220px] gap-4">
        ...
        <div style={{ marginLeft: "10px", marginTop: "10px" }}>
          ...
          >
            Never miss your sacred anniversary.
          </p>
        ...
        >
          ...
          >
            When your anniversary approaches, BrajMarg will:
          </h4>
          ...
          >
            {[
              "Recommend anniversary sevas from your followed temples",
              "Suggest auspicious prasad offerings",
              "Send blessings and reminders before your special day",
            ].map((item) => (
