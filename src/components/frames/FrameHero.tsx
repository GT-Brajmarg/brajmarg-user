...
const frameDescription =
  "Beautifully crafted Pichwai frame of Lord Shreenathji, inspired by traditional Nathdwara art. Perfect for your home temple or as a spiritual gift for your loved ones.";

export default function FrameHero({ templeSlug, temple, frame }: Props) {
  return (
          ...
          <div className="flex w-fit items-center gap-24">
            ...
            <div className="relative h-[450px] w-[620px]">
              <div
                ...
                style={{ marginTop: "-40px" }}
              >
                <div className="absolute top-1/2 left-1/2 z-10 h-[450px] w-[400px] -translate-x-1/2 -translate-y-1/2 overflow-hidden">
                  <Image
              ...
              >
                ...
                <div className="flex flex-col items-center px-5 text-center">
                  ...
                  <p className="font-cormorant text-[15px] leading-5 text-[#5B5146]">
                    Inspired by
                    <br />
                    {temple.location?.split(",")[0].trim()} Art
                  </p>
                </div>
