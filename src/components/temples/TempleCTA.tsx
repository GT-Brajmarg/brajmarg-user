        ...
        <div className="flex flex-col items-center gap-6 rounded-[18px] border-2 border-[#C37000] bg-[#EFDEC7]/20 px-5 py-6 text-center md:h-[120px] md:flex-row md:px-[60px] md:text-left">
          <div className="flex flex-1 flex-col items-center gap-4 md:flex-row">
            ...
            <div className="text-center md:-ml-10 md:text-left">
              ...
              <p
                className="mt-2 text-[16px] leading-6 text-[#3D352F] md:text-[15px]"
                style={{ fontWeight: "500" }}
              >
                Request us to add a temple and help others connect with divine
                places.
          ...
          <button
            onClick={() => setOpen(true)}
            className="ml-auto hidden h-[42px] min-w-[185px] items-center justify-center rounded-[8px] bg-[#0D6B73] px-6 text-[#EFDEC7] transition hover:bg-[#0A5960] md:flex"
            style={{ marginRight: "55px" }}
          >
            <p className="font-cormorant text-[16px]">Request a Temple →</p>
          </button>
          ...
          <button
            onClick={() => setOpen(true)}
            className="flex h-[46px] w-full max-w-[260px] items-center justify-center rounded-[8px] bg-[#0D6B73] px-6 text-[#EFDEC7] transition hover:bg-[#0A5960] md:hidden"
